...
<h2><div style="font-size:30px; color:#FF8C00;font-family:Bradley hand itc">View Hotel Registerations</div></h2>
...
<th> <strong>Disapprove</strong></th>
</tr>
</thead>
<tbody>
<?php
$count=1;
$sel_query="SELECT `Name`, `address`, `PhoneNumber`, `psw`, `email`,`image`,`is_approve` FROM `registers_details_ngo` WHERE `is_approve`=0";
...
<td align="center"> <a href="image1.php?email=<?php echo $row["email"]; ?>" style=" color:#ff8c00;">view</a></td>
<td align="center">
<a href="edit1.php?email=<?php echo $row["email"]; ?>"style=" color:white;">Edit</a>
</td>
<td align="center">
<a href="delete1.php?email=<?php echo $row["email"]; ?>" style=" color:white;">Delete</a>
</td>
</tr>
<?php $count++; } ?>
</tbody>
