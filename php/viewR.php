...
<?php
$count=1;
$sel_query="SELECT `Name`, `address`, `PhoneNumber`, `psw`, `email`,`image`,`is_approve` FROM `registers_details` WHERE `is_approve`=0";
...
<td align="center"> <a href="image.php?email=<?php echo $row["email"]; ?>" style=" color:#ff8c00;">view</a></td>
<td align="center">
<a href="edit.php?email=<?php echo $row["email"]; ?>"style=" color:white;">Edit</a>
</td>
<td align="center">
<a href="delete.php?email=<?php echo $row["email"]; ?>" style=" color:white;">Delete</a>
</td>
</tr>
<?php $count++; } ?>
</tbody>
